...
fun ownTvColors(
    ...
    return if (isDark) {
        OwnTVColors(
            ...
            surfaceContainer = Color(0xFF1B1C21),
            surfaceContainerHigh = Color(0xFF22242A),
            surfaceContainerHighest = Color(0xFF2A2C33),
            onSurface = Color(0xFFF5F5F7),
            onSurfaceVariant = Color(0xFFAAADB6),
            outline = Color(0xFF41434B),
            outlineVariant = Color(0xFF2B2D34),
            primary = if (accent == AccentColor.TEAL && customAccent.isBlank()) Color(0xFFF59E0B) else primary,
            onPrimary = if (accent == AccentColor.TEAL && customAccent.isBlank()) Color(0xFF211500) else roles.onPrimary,
            primaryContainer = if (accent == AccentColor.TEAL && customAccent.isBlank()) Color(0xFF5A4100) else roles.primaryContainer,
            onPrimaryContainer = if (accent == AccentColor.TEAL && customAccent.isBlank()) Color(0xFFFFE8B0) else roles.onPrimaryContainer,
